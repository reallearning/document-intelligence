...
import { 
  ...
  Users, Zap, Send, RotateCcw, Bell, Target, TrendingUpIcon
} from 'lucide-react';
                        ...
                        <div className="flex-1">
                          ...
                          <div className="grid grid-cols-5 gap-4 mb-5">
                            ...
                            <div className="p-4 rounded-lg" style={{ backgroundColor: '#85A38315' }}>
                              ...
                              <div className="text-xl font-medium" style={{ color: '#85A383' }}>{item.decisionFactors.supplyChain.supplierData?.leadTime || 'N/A'}</div>
                            </div>
                          </div>
                        ...
                        <div className="flex-1">
                          ...
                          <div className="grid grid-cols-5 gap-4 mb-5">
                            ...
                            <div className="p-4 rounded-lg" style={{ backgroundColor: '#FFEEE0' }}>
                              ...
                              <div className="text-xl text-[#0C2C18] font-light">{item.decisionFactors.supplyChain.logisticsData?.transferCost || 'N/A'}</div>
                            </div>
                            <div className="p-4 rounded-lg" style={{ backgroundColor: '#85A38315' }}>
