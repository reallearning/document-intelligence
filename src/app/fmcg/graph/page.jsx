...
export default function Page() {
  ...
  const nodes = [
    ...
    },
    {
      ...
      size: 16,
      type: "circle",
      properties: ["brand_id", "brand_name", "portfolio", "status"],
    },
    {
      id: "variant",
      name: "Variant",
      ...
      size: 14,
      type: "circle",
      properties: ["variant_id", "variant_name", "status"],
    },
    {
      id: "category",
      name: "Category",
    ...
    },
    {
      ...
      size: 14,
      type: "circle",
      properties: ["segment_id", "segment_name"],
    },
    {
      id: "packformat",
      name: "PackFormat",
      ...
      size: 12,
      type: "circle",
      properties: ["pack_format_id", "pack_format_name"],
    },
    {
      id: "uom",
      name: "UoM",
      ...
      size: 12,
      type: "circle",
      properties: ["uom_id", "uom_code", "uom_desc"],
    },
    {
      id: "uomconversion",
      name: "UoMConversion",
    ...
    },
    {
      ...
      size: 12,
      type: "circle",
      properties: ["bom_id", "sku_id", "version", "valid_from", "valid_to"],
    },
    {
      id: "bomcomponent",
      name: "BOMComponent",
    ...
    },
    {
      ...
      size: 12,
      type: "circle",
      properties: ["material_id", "material_name", "material_type", "base_uom"],
    },
    ...
    // B) Geography and Time
    {
      ...
      size: 16,
      type: "circle",
      properties: ["geo_id", "geo_name", "geo_type", "parent_geo_id"],
    },
    {
      id: "timeday",
      name: "TimeDay",
      ...
      size: 13,
      type: "circle",
      properties: ["date", "week_id", "month_id", "fiscal_period_id"],
    },
    {
      id: "timeweek",
      name: "TimeWeek",
      ...
      size: 13,
      type: "circle",
      properties: ["week_id", "week_start_date", "week_end_date", "month_id"],
    },
    {
      id: "timemonth",
      name: "TimeMonth",
    ...
    // C) RTM / Customer / Outlet
    {
      ...
      size: 16,
      type: "circle",
      properties: ["channel_id", "channel_name"],
    },
    {
      id: "customer",
      name: "Customer",
    ...
    },
    {
      ...
      size: 12,
      type: "circle",
      properties: ["customer_group_id", "group_name", "group_type"],
    },
    {
      id: "outlet",
      name: "Outlet",
    ...
    },
    {
      ...
      size: 14,
      type: "circle",
      properties: ["territory_id", "territory_name", "territory_level"],
    },
    {
      id: "route",
      name: "RouteBeat",
      ...
      size: 12,
      type: "circle",
      properties: ["route_id", "route_name", "territory_id", "status"],
    },
    {
      id: "salesrep",
      name: "SalesRep",
      ...
      size: 11,
      type: "circle",
      properties: ["rep_id", "rep_name", "rep_type", "territory_id"],
    },
    ...
    {
      id: "carrier",
      name: "CarrierTransporter",
      group: "Supply",
      color: "#F59E0B",
      size: 11,
      type: "circle",
      properties: ["carrier_id", "carrier_name", "mode_supported"],
    },
    ...
    // F) Orders & Fulfillment
    {
      ...
      properties: [
        ...
        "ordered_by_customer_id",
        "ship_from_node_id",
        "deliver_to_customer_id",
        "deliver_to_outlet_id",
        "channel_id",
      ],
    },
    {
    ...
    // Inventory & Distribution Decisions
    {
      ...
      decisionData: {
        ...
        category: "Inventory",
        output:
          "Ranked list of distributors at risk (SKU-specific), earliest stockout first",
        optimizes: "Reduce stockouts / protect service",
      },
    },
    {
      id: "d002",
      name: "Replenishment Qty",
      group: "Decisions",
      color: "#02220E",
      size: 16,
      type: "triangle",
      decisionData: {
        ...
        category: "Inventory",
        output:
          "Recommended ship quantities in cases per SKU for each distributor",
    ...
    },
    {
      ...
      decisionData: {
        ...
        category: "Service",
        output:
          "List of customers/lanes where interventions yield highest OTIF gain",
        optimizes: "OTIF uplift with minimal operational disruption",
      },
    },
    {
      id: "d010",
      name: "Forecast Override",
      group: "Decisions",
      color: "#02220E",
      size: 15,
      type: "triangle",
  ...
  const createVisualization = () => {
    ...
    const simulation = d3
      ...
      .force(
        ...
        d3
          ...
          .id((d) => d.id)
          .distance((d) =>
            d.type === "metric" ? 140 : d.type === "decision" ? 160 : 120,
          ),
      )
      ...
      .force(
        "collision",
        d3.forceCollide().radius((d) => d.size + 30),
      )
      .force(
        "x",
        d3
          .forceX(width / 2)
          .strength((d) =>
            d.type === "hexagon" ? 0.05 : d.type === "triangle" ? 0.08 : 0.02,
          ),
      )
      .force(
        "y",
    ...
    const link = g
      ...
      .attr("stroke-width", (d) =>
        d.type === "metric" || d.type === "decision" ? 2 : 1.5,
      )
      .attr("stroke-opacity", (d) =>
        d.type === "metric" || d.type === "decision" ? 0.7 : 0.6,
      )
      .attr("stroke-dasharray", (d) => (d.type === "dashed" ? "4,4" : "0"))
      .attr("marker-end", (d) =>
        d.type === "metric"
          ? "url(#arrowhead-metric)"
          : d.type === "decision"
...
<div className='flex flex-col h-screen bg-white'>
  <div className='flex flex-1 overflow-hidden'>
     <div className={`flex-1 overflow-hidden`}>
          <div className="bg-gray-50 h-full overflow-hidden border border-gray-200">
