...
export default function Page() {
  ...
  const [nodes, setNodes] = useState<Node[]>([
    ...
    /* =========================
       DATA SOURCES (NEW) - type: source
       ========================= */
    {
      id: "sap_s4hana",
      name: "SAP S/4HANA (or ECC)",
      description:
        "ERP backbone: SKU/materials, pricing/conditions, sales orders/invoices, inventory, procurement, FI postings.",
      width: 220,
      height: 50,
      size: 0,
      color: "#0F172A",
    ...
    },
    {
      ...
      description:
        "Distributor operations: secondary sales, outlet master, claims, beat-wise execution data (where applicable).",
      width: 260,
      height: 50,
      size: 0,
      color: "#0F172A",
    ...
    {
      id: "sfa",
      name: "SFA / Mobility (Sales Force Automation)",
      description:
        "Beat coverage, outlet visits, order capture, visibility execution, merchandising audits, competitor sightings.",
      width: 270,
      height: 50,
      size: 0,
      color: "#0F172A",
    ...
    {
      id: "mt_portals",
      name: "Modern Trade Portals / EDI",
      description:
        "KA POs, invoices, listings, deductions/penalties, GRNs, fill-rate and compliance signals.",
      width: 260,
      height: 50,
      size: 0,
      color: "#0F172A",
    ...
    },
    {
      ...
      name: "WMS",
      description:
        "DC operations: bin stock, picking, dispatch, transfers, batch/lot, aging, damages.",
      width: 160,
      height: 50,
      size: 0,
      color: "#0F172A",
    ...
    },
    {
      ...
      name: "TMS / Logistics",
      description:
        "Shipments, lanes, carriers, freight cost, POD, OTIF, damages/claims.",
      width: 190,
      height: 50,
      size: 0,
      color: "#0F172A",
    ...
    {
      id: "ibp_anaplan_o9",
      name: "Planning (SAP IBP / Anaplan / o9)",
      description:
        "Forecast versions, S&OP consensus plans, overrides and scenarios, allocations.",
      width: 260,
      height: 50,
      size: 0,
      color: "#0F172A",
    ...
    },
    {
      ...
      name: "PLM",
      description:
        "Product lifecycle: formulations/BOM, packaging specs, artwork, claims substantiation, change control.",
      width: 150,
      height: 50,
      size: 0,
      color: "#0F172A",
    ...
    },
    {
      ...
      name: "MES",
      description:
        "Manufacturing execution: production orders, batch genealogy, yields, line KPIs, downtime reasons.",
      width: 170,
      height: 50,
      size: 0,
      color: "#0F172A",
    ...
    },
    {
      ...
      name: "LIMS / QMS",
      description:
        "QC tests, COAs, deviations/CAPA, release status, audit evidence.",
      width: 180,
      height: 50,
      size: 0,
      color: "#0F172A",
    ...
    },
    {
      ...
      name: "CRM / CDP",
      description:
        "Consumer identity & interactions (D2C), segmentation, service tickets, complaint workflows.",
      width: 180,
      height: 50,
      size: 0,
      color: "#0F172A",
    ...
    {
      id: "ad_platforms",
      name: "Ad Platforms (Meta/Google, etc.)",
      description:
        "Spend, impressions, clicks, conversions, ROAS; campaign metadata.",
      width: 270,
      height: 50,
      size: 0,
      color: "#0F172A",
    ...
    {
      id: "d2c_platform",
      name: "D2C Platform (Shopify/Magento/etc.)",
      description: "Catalog, orders, payments, returns, funnel analytics.",
      width: 250,
      height: 50,
      size: 0,
      color: "#0F172A",
    ...
    {
      id: "marketplaces",
      name: "Marketplaces (Amazon/Flipkart, etc.)",
      description:
        "Listings, pricing, availability, ratings/reviews, settlement reports.",
      width: 280,
      height: 50,
      size: 0,
      color: "#0F172A",
    ...
    {
      id: "nielsen_kantar",
      name: "NielsenIQ / Kantar",
      description:
        "Market share, category trends, price ladders, competitive benchmarks.",
      width: 220,
      height: 50,
      size: 0,
      color: "#0F172A",
    ...
    {
      id: "weather_events",
      name: "Weather & Events Feeds",
      description:
        "Weather, heatwaves/rainfall, festival calendar, local events to model demand drivers.",
      width: 250,
      height: 50,
      size: 0,
      color: "#0F172A",
    ...
    },
    {
      ...
      name: "HRMS",
      description:
        "Employee master, roles, org structure, incentives/targets (where applicable).",
      width: 160,
      height: 50,
      size: 0,
      color: "#0F172A",
  ...
  const [links, setLinks] = useState<Link[]>([
       ...
       ========================= */
    {
      ...
      description: "Material/SKU master incl. MRP/UoM/tax.",
      linkType: "data",
    },
    {
      id: "d_erp_2",
      ...
      target: "pricing_condition",
      type: "SYSTEM_OF_RECORD",
      description: "Pricing conditions / discounts / taxes rules.",
      linkType: "data",
    },
    {
      id: "d_erp_3",
      ...
      target: "sales_order",
      type: "CAPTURES",
      description: "Primary orders (header+lines).",
      linkType: "data",
    },
    {
      id: "d_erp_4",
      ...
      target: "invoice",
      type: "CAPTURES",
      description: "Invoices, taxes, freight, terms.",
      linkType: "data",
    },
    {
      id: "d_erp_5",
      ...
      target: "inventory",
      type: "SYSTEM_OF_RECORD",
      description: "Inventory balances/valuation/blocked stock.",
      linkType: "data",
    },
    {
      id: "d_erp_6",
      ...
      target: "purchase_order",
      type: "CAPTURES",
      description: "Procurement POs and schedules.",
      linkType: "data",
    },
    {
      id: "d_erp_7",
      ...
      target: "collections",
      type: "CAPTURES",
      description: "Receivables and collection postings (where configured).",
      linkType: "data",
    },
    {
      id: "d_erp_8",
      ...
      target: "tax_filing",
      type: "PROVIDES",
      description: "GST outputs / filing extracts (or feeds GST tool).",
      linkType: "data",
    },

    {
      ...
      target: "secondary_sales",
      type: "SYSTEM_OF_RECORD",
      description: "Distributor→outlet secondary sales.",
      linkType: "data",
    },
    {
      id: "d_dms_2",
      ...
      target: "secondary_line",
      type: "CAPTURES",
      description: "Outlet×SKU off-take line items.",
      linkType: "data",
    },
    {
      id: "d_dms_3",
      ...
      target: "outlet",
      type: "SYSTEM_OF_RECORD",
      description: "Outlet master (if maintained via DMS).",
      linkType: "data",
    },
    {
      id: "d_dms_4",
      ...
      target: "scheme_settlement",
      type: "CAPTURES",
      description: "Claims and settlements (common via distributor workflows).",
      linkType: "data",
    },

    {
      ...
      target: "beat",
      type: "SYSTEM_OF_RECORD",
      description: "Beat plans, visit cadence, coverage.",
      linkType: "data",
    },
    {
      id: "d_sfa_2",
      ...
      type: "CAPTURES",
      description:
        "Outlet audits: shelf, visibility, compliance, competitor signals.",
      linkType: "data",
    },
    {
      id: "d_sfa_3",
      ...
      target: "sales_order",
      type: "PROVIDES",
      description: "Order capture that may flow into ERP.",
      linkType: "data",
    },

    {
      ...
      target: "key_account",
      type: "SYSTEM_OF_RECORD",
      description: "KA trading terms/portal entities.",
      linkType: "data",
    },
    {
      id: "d_mt_2",
      ...
      target: "listing",
      type: "CAPTURES",
      description: "Listings on/off, compliance and penalties.",
      linkType: "data",
    },

    {
      ...
      target: "dc",
      type: "SYSTEM_OF_RECORD",
      description: "Warehouse/DC master & locations.",
      linkType: "data",
    },
    {
      id: "d_wms_2",
      ...
      target: "inventory_position",
      type: "CAPTURES",
      description: "SKU×location×batch aging/availability.",
      linkType: "data",
    },
    {
      id: "d_wms_3",
      ...
      target: "shipment",
      type: "CAPTURES",
      description: "Dispatch events and transfer docs (warehouse side).",
      linkType: "data",
    },

    {
      ...
      target: "shipment",
      type: "SYSTEM_OF_RECORD",
      description: "Shipment lifecycle, POD, damages.",
      linkType: "data",
    },
    {
      id: "d_tms_2",
      ...
      target: "lane",
      type: "SYSTEM_OF_RECORD",
      description: "Lane SLAs, carriers, freight cost.",
      linkType: "data",
    },

    {
      id: "d_plan_1",
      source: "ibp_anaplan_o9",
      target: "forecast",
      type: "SYSTEM_OF_RECORD",
      description: "Forecast values and versions.",
      linkType: "data",
    },
    {
      id: "d_plan_2",
      ...
      target: "forecast_version",
      type: "CAPTURES",
      description: "Baseline vs uplift vs override versions.",
      linkType: "data",
    },
    {
      id: "d_plan_3",
      ...
      target: "sop",
      type: "SYSTEM_OF_RECORD",
      description: "S&OP consensus plan and scenarios.",
      linkType: "data",
    },
    {
      id: "d_plan_4",
      ...
      target: "supply_plan",
      type: "CAPTURES",
      description: "Supply allocation plans to plants/DCs.",
      linkType: "data",
    },

    {
      ...
      target: "formula",
      type: "SYSTEM_OF_RECORD",
      description: "BOM/formula & specifications.",
      linkType: "data",
    },
    {
      id: "d_plm_2",
      ...
      target: "pack",
      type: "SYSTEM_OF_RECORD",
      description: "Packaging specs/artwork/labels.",
      linkType: "data",
    },
    {
      id: "d_plm_3",
      ...
      target: "claim",
      type: "SYSTEM_OF_RECORD",
      description: "Claims and substantiation mapping.",
      linkType: "data",
    },
    {
      id: "d_plm_4",
      ...
      target: "change_control",
      type: "CAPTURES",
      description: "Controlled changes to formula/pack/label.",
      linkType: "data",
    },
    {
      id: "d_plm_5",
      ...
      target: "lifecycle",
      type: "CAPTURES",
      description: "Lifecycle stages/phase-out controls.",
      linkType: "data",
    },

    {
      ...
      target: "batch",
      type: "CAPTURES",
      description: "Batch genealogy and production records.",
      linkType: "data",
    },
    {
      id: "d_mes_2",
      ...
      target: "prod_line",
      type: "PROVIDES",
      description: "Line KPIs: yield loss, downtime, OEE components.",
      linkType: "data",
    },

    {
      ...
      target: "qc_test",
      type: "SYSTEM_OF_RECORD",
      description: "QC test results and release status.",
      linkType: "data",
    },
    {
      id: "d_qms_2",
      ...
      target: "coa",
      type: "CAPTURES",
      description: "COA certificates tied to batches.",
      linkType: "data",
    },
    {
      id: "d_qms_3",
      ...
      target: "deviation",
      type: "CAPTURES",
      description: "Deviations, investigations, CAPA.",
      linkType: "data",
    },

    {
      ...
      target: "consumer_feedback",
      type: "CAPTURES",
      description: "Complaints/NPS/service signals.",
      linkType: "data",
    },
    {
      id: "d_crm_2",
      ...
      target: "complaint_ticket",
      type: "CAPTURES",
      description: "Ticket details: defect tags, severity, resolution.",
      linkType: "data",
    },

    {
      ...
      target: "media_plan",
      type: "PROVIDES",
      description: "Spend, reach, performance metrics.",
      linkType: "data",
    },
    {
      id: "d_ads_2",
      ...
      target: "digital_kpi",
      type: "PROVIDES",
      description: "ROAS/CAC/CTR style KPIs by date/campaign.",
      linkType: "data",
    },

    {
      ...
      target: "storefront",
      type: "SYSTEM_OF_RECORD",
      description: "D2C storefront presence.",
      linkType: "data",
    },
    {
      id: "d_d2c_2",
      ...
      target: "catalog_item",
      type: "CAPTURES",
      description: "Catalog items mapped to SKUs.",
      linkType: "data",
    },
    {
      id: "d_d2c_3",
    ...
    },
    {
      ...
      target: "digital_order_line",
      type: "CAPTURES",
      description: "D2C order lines mapped to SKUs.",
      linkType: "data",
    },
    {
      id: "d_d2c_5",
      ...
      target: "digital_analytics",
      type: "PROVIDES",
      description: "Traffic/funnel KPIs.",
      linkType: "data",
    },

    {
      ...
      target: "mkt_listing",
      type: "SYSTEM_OF_RECORD",
      description: "Marketplace listings & availability.",
      linkType: "data",
    },
    {
      id: "d_mktp_2",
      ...
      target: "listing_sku",
      type: "CAPTURES",
      description: "Listing-to-SKU mappings.",
      linkType: "data",
    },
    {
      id: "d_mktp_3",
      ...
      target: "review",
      type: "PROVIDES",
      description: "Ratings & review text.",
      linkType: "data",
    },

    {
      ...
      target: "competition",
      type: "PROVIDES",
      description: "Share/benchmarks and competitive comparisons.",
      linkType: "data",
    },
    {
      id: "d_ext_2",
      ...
      target: "competitor_set",
      type: "PROVIDES",
      description: "Competitive sets and price ladders.",
      linkType: "data",
    },

    {
      ...
      target: "demand_driver",
      type: "PROVIDES",
      description: "Weather/events demand drivers.",
      linkType: "data",
    },
    {
      id: "d_wx_2",
      ...
      target: "event",
      type: "PROVIDES",
      description: "Festival/event calendar.",
      linkType: "data",
    },
    ...
    },
    {
      ...
      target: "role",
      type: "SYSTEM_OF_RECORD",
      description: "Role master and mappings.",
      linkType: "data",
    },
  ]);
