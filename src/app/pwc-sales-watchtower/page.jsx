...
export default function QuesttSalesWatchtower() {
  ...
  return (
    <div className="overflow-auto" style={{ height: '100vh', backgroundColor: C.offWhite, fontFamily: font }}>
      ...
      {/* Page Header */}
      <div style={{ backgroundColor: C.darkGreen, padding: '16px 48px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
              <div style={{ display: 'flex', alignItems: 'center' }}>
                <span style={{ fontSize: '15px', fontWeight: '500', letterSpacing: 0, fontFamily: font, opacity: 0.85, color: C.white }}>questt</span>
                <span style={{ color: '#3BB896', fontSize: '15px', fontWeight: '700' }}>.</span>
              </div>
              <span style={{ fontSize: '9px', opacity: 0.45, fontWeight: '400', letterSpacing: '0.3px', marginTop: '-1px', color: C.white }}>powered by PwC</span>
            </div>
            <span style={{ opacity: 0.25, margin: '0 10px', color: C.white }}>|</span>
            <span style={{ fontSize: '14px', opacity: 0.6, fontWeight: '400', color: C.white }}>Sales Watchtower</span>
          </div>
        </div>
      </div>
                    ...
                    <div style={{ padding: '28px' }}>
                      ...
                      <div style={{ display: 'flex', gap: '12px' }}>
                        ...
                        >
                          ...
                          Discuss with questt<span style={{ color: '#3BB896', fontWeight: '700' }}>.</span>
                        </button>
                      </div>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
              <div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '6px', marginBottom: '8px' }}>
                  <div style={{ width: 18, height: 18, borderRadius: 9, background: C.sage, display: 'flex', alignItems: 'center', justifyContent: 'center' }}><span style={{ color: '#fff', fontSize: 9, fontWeight: 700 }}>q</span></div>
                  <span style={{ fontSize: '13px', fontWeight: '600', color: C.green, fontFamily: font }}>questt</span>
                  <span style={{ color: '#3BB896', fontSize: '13px', fontWeight: '700' }}>.</span>
                </div>
