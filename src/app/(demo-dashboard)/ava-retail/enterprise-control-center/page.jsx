    ...
    <div className="flex flex-col w-full h-screen bg-gray-50 p-6 overflow-y-auto">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-black">
              AvaRetail - Enterprise Control Center
            </h1>
      ...
      <div className="grid grid-cols-2 gap-6 mb-8">
        <AgentCard
          ...
          onClick={() => {
            router.push("/ava-retail/business-intelligence");
          }}
        />
        ...
        <AgentCard
          ...
          onClick={() => {
            router.push("/dashboard?origin=ava-retail");
          }}
        />
        <AgentCard
          ...
          onClick={() => {
            router.push("/ava-retail/risk-and-compliance");
          }}
        />
        ...
        <AgentCard
          ...
          onClick={() => {
            router.push("/ava-retail/budgeting-forecasting");
          }}
        />
      </div>
