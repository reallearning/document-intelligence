...
const DealsDetails = () => {
  ...
  const handleMarkReview = () => {
    if (params.id === "acme-tech") {
      router.push(`${id}/revenue-schedule`);
    }
  };
      ...
      <div className="px-4 pt-1 pb-4 flex items-center justify-between border-b border-[#E2E8F0] mb-6">
        ...
        <div className="">
          ...
          >
            ...
            <option value="eeconciliation">Reconciliation</option>
          </select>
        </div>
      </div>
      <div className="flex">
        ...
        <div className="flex flex-col pl-6 w-full">
          <div className="flex justify-end pr-4 w-full">
            <button
              className="text-white bg-[#7C3AED] px-4 py-2 rounded-lg"
